...
# use this to produce the figure in the paper about naive cragg
rm(list = ls())

# choose your gamma and beta values
gammas = seq(-5,5,length=10)
beta2 = .02
rhos = seq(-1,1,length=10)
...
# test for changing values of rho -- for all values of rho, underestimates
# same level of bias as for changing gammas, just that y axes different
rm(list = ls())
